...
def run_main(flags, default_hparams, train_fn, inference_fn, target_session=""):
  ...
  if flags.inference_input_file:
    ...
    # Train
    utils.print_out(  'begin to train...' )
...
if __name__ == "__main__":
  ...
  arguments = '--src=vi --tgt=en   --vocab_prefix=F:/workspace/Tensorflow/src/deep-learning-with-keras-notebooks/10-5-deeplearning-translation/nmt_data/vocab   --train_prefix=F:/workspace/Tensorflow/src/deep-learning-with-keras-notebooks/10-5-deeplearning-translation/nmt_data/train   --dev_prefix=F:/workspace/Tensorflow/src/deep-learning-with-keras-notebooks/10-5-deeplearning-translation/nmt_data/tst2012   --test_prefix=F:/workspace/Tensorflow/src/deep-learning-with-keras-notebooks/10-5-deeplearning-translation/nmt_data/tst2013   --out_dir=F:/workspace/Tensorflow/src/deep-learning-with-keras-notebooks/10-5-deeplearning-translation/nmt/nmt_model   --num_train_steps=12000   --steps_per_stats=100   --num_layers=2   --num_units=128   --dropout=0.2   --metrics=bleu'
  FLAGS, unparsed = nmt_parser.parse_known_args( arguments.split() )
