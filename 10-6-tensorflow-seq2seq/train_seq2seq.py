...
@Package 
@author: ly
@date Date: 2019年08月05日 17:39
@Description: 
@URL: https://github.com/wavewangyue/tensorflow_seq2seq/blob/master/train_seq2seq.py
@version: V1.0
'''
...
if __name__ == '__main__':
    ...
    with tf.Session( config=tf_config ) as sess:
        ...
        for batch in range( batches ):
            source_batch, source_lens, target_batch, target_lens = get_batch( docs_source,
                                                                              w2i_source,
                                                                              docs_target,
                                                                              w2i_target,
                                                                              config.batch_size )
