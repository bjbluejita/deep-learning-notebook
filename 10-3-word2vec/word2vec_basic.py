...
@Package 
@author: ly
@date Date: 2019年07月02日 15:48
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_14/word2vec_basic.py
@version: V1.0
'''
...
def generate_batch( batch_size, num_skips, skip_window ):
    ...
    :param batch_size:
    :param num_skips: 从滑动窗口里选择num_skips个形成标签
    :param skip_window: 滑动窗口size（ 2*skip_window+1 ）
    :return:
    '''
    ...
    for step in xrange( num_steps ):
        ...
        if step % 2000 == 0:
            if step > 0:
                average_loss /= 2000
            # 2000个batch的平均损失
            print( 'Average loss at step[%d]->[%.6f]' %( step, average_loss ) )
            average_loss = 0
...
try:
    ...
    print( 'Please install sklearn, mathplotlib and scipy to show embedding')
