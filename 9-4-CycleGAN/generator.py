...
@Package 
@author: ly
@date Date: 2019年06月18日 10:18
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_11/generator.py
@version: V1.0
'''
...
class Generator:
    ...
    def __call__(self, input ):
        ...
        :param input: batch_size x width x height x 3
