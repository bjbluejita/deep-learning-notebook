...
@Package 
@author: ly
@date Date: 2019年06月19日 10:53
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_11/train.py
@version: V1.0
'''
...
tf.flags.DEFINE_float('pool_size', 0,
            ...
            while not coord.should_stop():
                ...
                _, G_loss_val, D_Y_loss_val, F_loss_val, D_X_loss_val, summary =(
                    sess.run(
                        ...
                        feed_dict={ cycle_gan.fake_y: fake_X_pool.query( fake_y_val ),
