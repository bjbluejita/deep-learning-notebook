...
@Package 
@author: ly
@date Date: 2019年06月17日 10:51
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_11/build_data.py
@version: V1.0
'''
...
tf.flags.DEFINE_string( 'X_input_dir', 'data/apple2orange/trainA',
                        'X input director,default: data/apple2orange/trainA' )
...
def data_reader( input_dir, shuffle=True ):
    ...
    :param input_dir: string, path of input dir, e.g., /path/to/dir
    :param shuffle:
    :return: file_paths: list of strings
    '''
    file_paths = []
...
def _convert_to_example( file_path, image_buffer ):
    ...
    :param file_path: path to an image file, e.g., '/path/to/example.JPG'
    :param image_buffer: tring, JPEG encoding of RGB image
...
def main( unused_argv ):
    ...
    print( 'Convert Y data to tfrecord...' )
