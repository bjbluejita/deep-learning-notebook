...
@Package 
@author: ly
@date Date: 2019年11月15日 11:18
@Description: 
@URL:https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_20/agents/statistic.py
@version: V1.0
'''
import os
import numpy as np
...
class Statistic( object ):
    ...
    def load_model(self ):
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            print( " [*] Model Load SUCCESS %s" % fname )
            return True
        else:
            print( " [!]Model Load FAILED %s" % self.model_dir )
            return False
