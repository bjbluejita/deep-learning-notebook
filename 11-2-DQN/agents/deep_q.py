...
@Package 
@author: ly
@date Date: 2019年11月15日 16:01
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_20/agents/deep_q.py
@version: V1.0
'''
import os
import time
...
class DeepQ( Agent ):
    ...
    def q_learning_minibatch( self ):
        ...
        if self.double_q:
            ...
            q_t_plus_1_with_pred_action = self.targets.calc_outputs_with_idx(
