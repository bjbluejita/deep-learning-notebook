...
@Package 
@author: ly
@date Date: 2019年11月15日 10:24
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_20/agents/experience.py
@version: V1.0
'''
import random
import numpy as np
...
class Experience( object ):
    def __init__(self, data_format, batch_size, history_length, memory_size, observation_dims ):
        ...
        #pre-allocate prestates and prestates for minbatch
    ...
    def retreive(self, index ):
        ...
        if index >= self.history_length - 1:
            ...
            indexes = [ (index - 1 ) % self.count for i in reversed( range( self.history_length)) ]
