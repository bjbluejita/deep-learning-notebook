...
@Package 
@author: ly
@date Date: 2019年11月18日 14:28
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_20/environments/environment.py
@version: V1.0
'''
import gym
import random
...
class AtariEnvironment( Environment ):
    def __init__(self, env_name, n_action_repeat, max_random_start,
        ...
        super( AtariEnvironment, self ).__init__( env_name, n_action_repeat, max_random_start,
                                                  observation_dims, data_format, display, use_cumulated_reward
                                                  )
