...
@Package 
@author: ly
@date Date: 2019年11月19日 11:21
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_20/networks/cnn.py
@version: V1.0
'''
import os
    ...
    def __init__(self, sess,
        ...
        with tf.variable_scope( name ):
            if network_header_type.lower() == 'nature':
                ...
                self.l4, self.var['l4_w'], self.var['l4_b'] = linear( self.l3, 512, weights_initializer, biases_initializer,
                ...
                self.l2, self.var['l2_w'], self.var['l2_b'] = conv2d( self.l1,
                                                                      ...
                                                                      hidden_activation_fn, data_format, name='l2_conv' )
                self.l3, self.var['l3_w'], self.var['l3_b'] = linear( self.l2,
                                                                      256, weights_initializer, biases_initializer,
                                                                      hidden_activation_fn, data_format, name='l3_conv' )
                layer = self.l3
            else:
                raise  ValueError( 'Wrong DQN type: %s' % network_output_type )
