...
@Package 
@author: ly
@date Date: 2019年05月17日 10:34
@Description: 
@URL:https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_7/model.py
@version: V1.0
'''
...
def net( image, training ):
    ...
    image = tf.pad( image, [ [0,0], [10, 10], [0, 0], [0, 0] ], mode='REFLECT' )
