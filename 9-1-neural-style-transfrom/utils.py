...
@Package 
@author: ly
@date Date: 2019年05月23日 11:20
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_7/utils.py
@version: V1.0
'''
...
def _get_init_fn( FLAGS ):
    '''
    DESC: This function is copied from TF slim.
          Returns a function run by the chief worker to warm-start the training.
          Note that the init_fn is only run when initializing the model during the very
          first global step.
    :param FLAGS:
    :return:  An init function run by the supervisor.
    '''
