...
@Package 
@author: ly
@date Date: 2019年05月21日 14:44
@Description: 
@URL: https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_7/train.py
@version: V1.0
'''
    ...
    with tf.Graph().as_default():
        with tf.Session() as sess:
            ...
            try:
                ...
                saver.save(  sess, os.path.join( training_path, 'fast-style-model.ckpt' )  )
                tf.logging.info( 'tf.errors.OutOfRangeError: Done training..epoch limit reached' )
            finally:
                coord.request_stop()
            coord.join( threads )
