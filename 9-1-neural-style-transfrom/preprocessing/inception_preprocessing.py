...
@Package 
@author: ly
@date Date: 2019年05月16日 16:17
@Description: 
@URL:https://github.com/hzy46/Deep-Learning-21-Examples/blob/master/chapter_7/preprocessing/inception_preprocessing.py
@version: V1.0
'''
...
def distorted_bounding_box_crop( image,
    ...
    '''
    with tf.name_scope( scope, 'distorrted_bounding_box_crop', [image,bbox] ):
